...
<form class="registration-form py-5" action="<?php echo e(route('post.deliveryverifyOtp')); ?>" method="POST" id="otpForm"
...
<?php endif; ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make("admin.layouts.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Sommelier\resources\views/auth/deliveryotp.blade.php ENDPATH**/ ?>