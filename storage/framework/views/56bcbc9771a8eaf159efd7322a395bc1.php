...
<?php $__env->startSection("title"); ?> Items - Dashboard
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo e(route('admin.saveNewItem')); ?>" method="POST" enctype="multipart/form-data">
...
<div id="addBulkItemModal" class="modal fade mt-5" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo e(route('admin.itemBulkUpload')); ?>" method="POST" enctype="multipart/form-data">
                    <div class="form-group row">
...
<script>
    ...
    $(function() {
        ...
        var datatable = $('#itemsDatatable').DataTable({
            ...
            order: [[ 0, "desc" ]],
            ajax: '<?php echo e(route('admin.adminItemsDatatable')); ?><?php if($store_id != null): ?>?store_id=<?php echo e($store_id); ?><?php endif; ?>',
            columns: [
        ...
        $('#downloadSampleItemCsv').click(function(event) {
         ...
         $('.price').numeric({allowThouSep:false, maxDecimalPlaces: 2 });
          ...
          $('body').on("click", ".itemAction", function(e) {
             ...
             let url = "<?php echo e(url('/admin/item/disable/')); ?>/"+id;
             let self = $(this);
            $.ajax({
                url: url,
                type: 'GET',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Sommelier\resources\views/admin/items.blade.php ENDPATH**/ ?>