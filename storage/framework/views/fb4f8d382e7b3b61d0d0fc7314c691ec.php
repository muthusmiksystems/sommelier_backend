        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse; width: 100%; max-width: 600px;" class="content">
            ...
            <tr>
                <td bgcolor="#ffffff" style="padding: 40px 20px 0 20px; color: #555555; font-family: Arial, sans-serif; font-size: 20px; line-height: 30px;">
                	<p>Hi, <?php echo e($mailData["name"]); ?></p>
                    <p>Your booking request has been accepted and your booking reference is <?php echo e("#".$mailData["booking_id"]); ?></p>
                    <p style="margin:0;">Booking Date : <?php echo e($mailData["booking_date"]); ?></p>
                    <p style="margin:0;">Booking Time : <?php echo e($mailData["booking_time"]); ?></p>
                    <p style="margin:0;">No of pax : <?php echo e($mailData["no_of_pax"]); ?></p>
                    <?php if(!empty($mailData["comment"])): ?>
                        <p style="margin:0;">Comment : <?php echo e($mailData["comment"]); ?></p>
                    <?php endif; ?>
                </td>
            </tr>
            <tr>
                <td style="padding: 40px 20px 0 20px; color: #555555; font-family: Arial, sans-serif; font-size: 20px; line-height: 30px;">
                    <img style="height:150px;width:150px;" src="<?php echo e($message->embedData(base64_decode(\DNS2D::getBarcodePNG($mailData['booking_id'], 'QRCODE')), 'barcode.png')); ?>" />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="padding: 0px 20px 0 20px; color: #555555; font-family: Arial, sans-serif; font-size: 20px;">The <?php echo e($mailData['admin_name']); ?></td>
            </tr>
            <!--
            <tr>
                <td align="center" bgcolor="#e9e9e9" style="padding: 12px 10px 12px 10px; color: #888888; font-family: Arial, sans-serif; font-size: 12px; line-height: 18px;">
                    <b><?php echo e($mailData["restaurant_name"]); ?></b> | <?php echo e($mailData["restaurant_add"]); ?>
...
</html><?php /**PATH C:\xampp\htdocs\Sommelier\resources\views/emails/bookingConfirmClient.blade.php ENDPATH**/ ?>