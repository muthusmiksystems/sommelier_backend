...
<div class="content">
    <div class="col-md-12">
        <div class="card" style="min-height: 100vh;">
            <div class="card-body">
                <form action="<?php echo e(route('restaurant.saveRestaurantTableShift')); ?>" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <div class="col-lg-3">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <input type="text" class="form-control form-control-lg" name="breakfast_warning_covers" 
                                                                value="<?php echo e((!empty($shif_settings->breakfast_warning_covers)) ? $shif_settings->breakfast_warning_covers : ''); ?>" placeholder="Warning covers">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="col-lg-3">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <input type="text" class="form-control form-control-lg" name="lunch_warning_covers" 
                                                                value="<?php echo e((!empty($shif_settings->lunch_warning_covers)) ? $shif_settings->lunch_warning_covers : ''); ?>" placeholder="Warning covers">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="col-lg-3">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <input type="text" class="form-control form-control-lg" name="dinner_warning_covers" 
                                                                value="<?php echo e((!empty($shif_settings->dinner_warning_covers)) ? $shif_settings->dinner_warning_covers : ''); ?>" placeholder="Warning covers">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <?php $__currentLoopData = $table_info; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ind => $table): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div class="form-group row table_info_row">
                                                            ...
                                                            <div class="col-lg-3">
                                                                ...
                                                                <div class="col-lg-12">
                                                                    <select name="table_info[<?php echo e($counter); ?>][area_id]" class="form-control form-control-lg">
                                                                        <?php if(!$areas->isEmpty()): ?>
                                                                            <?php $__currentLoopData = $areas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $area): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                <option value="<?php echo e($area->id); ?>" <?php echo e(($area->id == $table->area_id) ? "selected='selected'" : ""); ?>><?php echo e($area->area_name); ?></option>
                                                            ...
                                                            <div class="col-lg-3">
                                                                ...
                                                                <div class="col-lg-12">
                                                                    <select name="table_info[<?php echo e($counter); ?>][table_type_id]" class="form-control form-control-lg">
                                                                        <?php if(!$table_types->isEmpty()): ?>
                                                                            <?php $__currentLoopData = $table_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $table_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                <option value="<?php echo e($table_type->id); ?>" <?php echo e(($table_type->id == $table->table_type_id) ? "selected='selected'" : ""); ?>><?php echo e($table_type->table_type_name); ?></option>
                                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                        <?php endif; ?>
                                                                    </select>
                                                                </div>
                                    ...
                                    <?php if(!$areas->isEmpty()): ?>
                                        ...
                                        <?php $__currentLoopData = $areas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $area): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="form-group row area_row">
                                                <div class="col-lg-10">
                                                    <div class="col-lg-12">
                                                        <input type="text" class="form-control colorpicker-show-input" name="restaurant_area[<?php echo e($counter); ?>][name]" data-preferred-format="rgb" value="<?php echo e($area->area_name); ?>" <?php echo e(($counter == 0 ) ? "readonly" : ""); ?>>
                                                        <input type="hidden" name="restaurant_area[<?php echo e($counter); ?>][id]" value="<?php echo e($area->id); ?>"/>
                                                    </div>
                                                </div>
                                                <div class="col-lg-2 remove_table_row_btn">
                                                    <?php if($counter != 0): ?>
                                ...
                                <div class="table_type_block">
                                    ...
                                    <?php if(!$table_types->isEmpty()): ?>
                                        <?php
                                            $counter = 0;
                                        ?>
                                        <?php $__currentLoopData = $table_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $tabletype): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="form-group row table_type_row">
                                                <div class="col-lg-10">
                                                    <div class="col-lg-12">
                                                        <input type="text" class="form-control colorpicker-show-input" name="table_types[<?php echo e($counter); ?>][name]" data-preferred-format="rgb" value="<?php echo e($tabletype->table_type_name); ?>" <?php echo e(($counter == 0 ) ? "readonly" : ""); ?>>
                                                        <input type="hidden" name="table_types[<?php echo e($counter); ?>][id]" value="<?php echo e($tabletype->id); ?>"/>
                                                    </div>
                                                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Sommelier\resources\views/restaurantowner/tableShiftRestaurant.blade.php ENDPATH**/ ?>