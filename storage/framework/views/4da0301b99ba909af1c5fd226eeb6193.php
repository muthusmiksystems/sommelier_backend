    ...
    <div class="page-header-content header-elements-md-inline">
        <div class="page-title d-flex">
            <h4>
                ...
                <span class="font-weight-bold mr-2"><?php echo e($couponTotal); ?> Coupons</span>
            </h4>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if(count($coupon->restaurants) > 1): ?>
                                <span class="badge badge-flat border-grey-800 text-default text-capitalize">MULTIPLE
                                    STORES</span>
                                <?php else: ?>
                                <?php $__currentLoopData = $coupon->restaurants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $couponRestaurant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <span
                                    class="badge badge-flat border-grey-800 text-default text-capitalize"><?php echo e($couponRestaurant->name); ?></span>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php endif; ?>
                            </td>
                            <td><b><?php echo e($coupon->code); ?></b></td>
                            <td>
                                <span class="badge badge-flat border-grey-800 text-default text-capitalize">
                                    <?php echo e($coupon->discount_type); ?>

                                </span>
                            </td>
                            <td>
                                <?php if($coupon->discount_type == "AMOUNT"): ?>
                                <?php echo e(config('setting.currencyFormat')); ?> <?php echo e($coupon->discount); ?>

                                <?php else: ?>
                                <?php echo e($coupon->discount); ?> <strong>%</strong>
                                <?php endif; ?>
                            </td>
                            <td><?php if($coupon->is_active): ?>
                                <span class="badge badge-flat border-grey-800 text-default text-capitalize">
                                    Active
                                </span>
                                <?php else: ?>
                            ...
                            <td><span
                                    class="badge badge-flat border-grey-800 text-default text-capitalize"><?php echo e($coupon->count); ?></span>
                            </td>
                            <td class="small">
                                <?php if(\Carbon\Carbon::now() > $coupon->expiry_date): ?>
                                <p class="mb-0 font-weight-bold text-danger blink-soft">EXPIRED</p>
                                <?php endif; ?>
                                <?php echo e($coupon->expiry_date->diffForHumans()); ?> <br>
                                (<?php echo e($coupon->expiry_date->format('Y-m-d')); ?>)
                            </td>
                            <td><?php echo e($coupon->min_subtotal); ?></td>
                            <td><?php if($coupon->max_discount): ?> <?php echo e($coupon->max_discount); ?> <?php else: ?> <span
                                    class="badge badge-flat border-grey-800 text-default text-capitalize">NA</span>
                                <?php endif; ?></td>
                            <td class="text-center">
                                <div class="btn-group btn-group-justified">
                                    <a href="<?php echo e(route('admin.get.getEditCoupon', $coupon->id)); ?>"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo e(route('admin.post.saveNewCoupon')); ?>" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-9">
                                <input type="text" class="form-control form-control-lg daterange-single"
                                    value="<?php echo e($todaysDate); ?>" name="expiry_date">
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Sommelier\resources\views/admin/coupons.blade.php ENDPATH**/ ?>