...
<?php $__env->startSection("title"); ?> Delivery Collections - Dashboard
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">
                    ...
                    <br>
                    <span>Cash in Hand: <?php echo e(config('setting.currencyFormat')); ?>
                    ...
                    <div class="form-group row hidden customAmountDiv">
                        ...
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg custom_amount" name="custom_amount"
                                placeholder="Enter the amount in <?php echo e(config('setting.currencyFormat')); ?>"
    ...
    $(function() {
        $('body').tooltip({selector: '[data-popup="tooltip"]'});
         var datatable = $('#deliveryCollectionDatatable').DataTable({
            ...
            order: [[ 0, "desc" ]],
            ajax: '<?php echo e(route('admin.deliveryCollectionDatatable')); ?>',
            columns: [
        ...
        $('body').on("click", ".collectCashBtn", function(e) {
            ...
            var postUrl = "<?php echo e(url('/admin/delivery-collection/collect/')); ?>" + '/' + userId;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Sommelier\resources\views/admin/deliveryCollections.blade.php ENDPATH**/ ?>