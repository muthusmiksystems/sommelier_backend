...
<?php $__env->startSection("title"); ?> Item Categories - Dashboard
    ...
    <div class="page-header-content header-elements-md-inline">
        <div class="page-title d-flex">
            <h4>
                ...
                <span class="font-weight-bold mr-2"><?php echo e($count); ?> Menu Categories</span>
            </h4>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span
                                    class="badge badge-flat border-grey-800 text-default text-capitalize"><?php if($itemCategory->is_enabled): ?>
                                    ENABLED <?php else: ?> DISABLED <?php endif; ?></span></td>
                            <td>
                                <span class="badge badge-flat border-grey-800 text-default text-capitalize">
                                    <?php if($itemCategory->user !== NULL): ?>
                                    <?php echo e($itemCategory->user->name); ?>
                            ...
                            <td class="text-center">
                                <div class="btn-group btn-group-justified align-items-center">
                                    <a href="javascript:void(0)" data-toggle="modal" data-target="#editItemCategory"
                                        data-catid="<?php echo e($itemCategory->id); ?>" data-catname="<?php echo e($itemCategory->name); ?>"
                                    ...
                                    <div class="checkbox checkbox-switchery ml-1" style="padding-top: 0.8rem;">
                                        <label>
                                            <input value="true" type="checkbox" class="action-switch"
                                                <?php if($itemCategory->is_enabled): ?> checked="checked" <?php endif; ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo e(route('admin.createItemCategory')); ?>" method="POST">
...
<div id="editItemCategory" class="modal fade" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo e(route('admin.updateItemCategory')); ?>" method="POST">
    ...
    $(function() {
        ...
        if (Array.prototype.forEach) {
         ...
         $('.action-switch').click(function(event) {
            ...
            let url = "<?php echo e(url('/admin/itemcategory/disable/')); ?>/"+id;
            window.location.href = url;
         });
    });
</script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Sommelier\resources\views/admin/itemcategories.blade.php ENDPATH**/ ?>