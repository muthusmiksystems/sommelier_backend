...
<?php $__env->startSection("title"); ?> Popular Geo Locations - Dashboard
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-group btn-group-justified">
                                    <?php if(!$location->is_default): ?>
                                    <?php if($location->is_active): ?>
                                    <a href="<?php if($location->is_default): ?> javascript:void(0) <?php else: ?> <?php echo e(route('admin.makeDefaultLocation', $location->id)); ?> <?php endif; ?>"
                                        class="btn btn-sm btn-dark ml-1" data-popup="tooltip" title="Make
                                        <?php echo e($location->name); ?> as Primary Location" data-placement="bottom"> <i
                                            class="icon-checkmark4"></i> </a>

                                    <a href="<?php echo e(route('admin.disablePopularGeoLocation', $location->id)); ?>"
                                    ...
                                    <a href="<?php echo e(route('admin.deletePopularGeoLocation', $location->id)); ?>"
                                        class="btn btn-sm btn-danger ml-1 doubleClickDelete" data-popup="tooltip"
                                        title="Double click to delete <?php echo e($location->name); ?>" data-placement="bottom"> <i
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo e(route('admin.saveNewPopularGeoLocation')); ?>" method="POST"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Sommelier\resources\views/admin/popularGeoLocations.blade.php ENDPATH**/ ?>