...
<?php $__env->startSection("title"); ?> Send Notifications - Dashboard
...
<div class="content mt-3">
    <div class="row">
        <div class="col-6 <?php if($countJunkData > 0): ?>col-xl-3 <?php else: ?> col-xl-4 <?php endif; ?> mb-2 mt-2" data-popup="tooltip"
            ...
            <div class="col-xl-12 dashboard-display p-3">
                <a class="block block-link-shadow text-left text-default" href="javascript:void(0)">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <div class="dashboard-display-number"><?php echo e($usersCount); ?></div>
        ...
        <div class="col-6 <?php if($countJunkData > 0): ?>col-xl-3 <?php else: ?> col-xl-4 <?php endif; ?> mb-2 mt-2" data-popup="tooltip"
            ...
            <div class="col-xl-12 dashboard-display p-3">
                <a class="block block-link-shadow text-left text-default" href="javascript:void(0)">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <div class="dashboard-display-number"><?php echo e($subscriberCount); ?></div>
        ...
        <div class="col-6 <?php if($countJunkData > 0): ?>col-xl-3 <?php else: ?> col-xl-4 <?php endif; ?> mb-2 mt-2" data-popup="tooltip"
            ...
            <div class="col-xl-12 dashboard-display p-3">
                <a class="block block-link-shadow text-left text-default" href="javascript:void(0)">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <div class="dashboard-display-number"><?php echo e($appUsers); ?></div>
        ...
        <div class="col-6 col-xl-3 mb-2 mt-2" data-popup="tooltip" title="Alters older than 7 days are not shown to the users and hence are of no
            use. Clicking on the below button will only delete <?php echo e($countJunkData); ?> Alerts data that
            are older than 7 days." onclick="confirmDelete()">
            <div class="col-xl-12 dashboard-display p-3">
                <a class="block block-link-shadow text-left text-danger" href="javascript:void(0)">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <div class="dashboard-display-number"><?php echo e($countJunkData); ?></div>
                    ...
                    <div class="d-lg-flex justify-content-lg-left">
                        ...
                        <div class="tab-content" style="width: 100%; padding: 0 25px;">
                            <div class="tab-pane fade show active" id="toAll">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        ...
                                        <div class="uploader">
                                            <form method="POST" action="<?php echo e(Route::currentRouteName() == 'restaurant.notifications' ? route('restaurant.uploadNotificationImage') : route('admin.uploadNotificationImage')); ?>"
                                ...
                                <form action="<?php echo e(Route::currentRouteName() == 'restaurant.notifications' ? route('restaurant.sendNotifiaction') : route('admin.sendNotifiaction')); ?>" method="POST"
                            ...
                            <div class="tab-pane fade" id="toSelected">
                                ...
                                <form action="<?php echo e(Route::currentRouteName() == 'restaurant.notifications' ? route('restaurant.sendNotificationToSelectedUsers') : route('admin.sendNotificationToSelectedUsers')); ?>" method="POST"
                                    enctype="multipart/form-data">
                                    <div class="form-group row">
                            ...
                            <div class="tab-pane fade" id="toNonRegisteredUsers">
                                ...
                                <form action="<?php echo e(Route::currentRouteName() == 'restaurant.notifications' ? route('restaurant.sendNotificationToNonRegisteredAppUsers') : route('admin.sendNotificationToNonRegisteredAppUsers')); ?>"
...
<script>
    ...
    $(function() {
       ...
       $('.select').select2({
           ...
           ajax: { 
                url: "<?php echo e(Route::currentRouteName() == 'restaurant.notifications' ? route('restaurant.getUsersToSendNotification') : route('admin.getUsersToSendNotification')); ?>",
                type: "get",
                dataType: 'json',
                delay: 250,
...
<script type="text/javascript">
    ...
    function confirmDelete()
    {
          ...
          if (r == true) {
            let url = "<?php echo e(url('admin/delete-alerts-junk')); ?>";
            window.location.href = url;
          }
    }
</script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Sommelier\resources\views/admin/notifications.blade.php ENDPATH**/ ?>