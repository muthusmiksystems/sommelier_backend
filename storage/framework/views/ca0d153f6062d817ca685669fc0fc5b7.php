...
<div class="content mt-3">
    <div class="d-flex justify-content-between my-2">
        ...
        <div>
            <?php if(\Nwidart\Modules\Facades\Module::find('CallAndOrder') && \Nwidart\Modules\Facades\Module::find('CallAndOrder')->isEnabled()): ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo e(route("storeOwner.saveNewUser")); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row hidden">
                        <label class="col-lg-3 col-form-label">Restaurant ID:</label>
                        <div class="col-lg-9">
                            <input class="form-control form-control-lg" type="text" name="restaurantIds[]" value="<?php echo e($restaurantIds[0] ?? ''); ?>">
                        </div>
                    </div>
...
<script>
    $(function () {
        ...
        var datatable = $('#usersDatatable').DataTable({
            ...
            order: [[0, "desc"]],
            ajax: '<?php echo e(route('storeOwner.usersDatatable')); ?>',
            columns: [
            ...
            buttons: {
                ...
                buttons: [{ extend: 'csv', filename: 'users-'+ new Date().toISOString().slice(0,10), text: 'Export as CSV' }]
            }
        });
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Sommelier\resources\views/admin/restauranUsers.blade.php ENDPATH**/ ?>