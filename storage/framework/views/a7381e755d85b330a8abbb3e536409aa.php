...
<div class="col-6 col-xl-3 mb-2 mt-2">
    <div class="col-xl-12 dashboard-display p-3">
        <a class="block block-link-shadow text-left text-default" href="javascript:void(0)">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <div class="dashboard-display-number" title="<?php echo e($displayEarnings); ?>" data-popup="tooltip"
                        data-placement="bottom"><?php echo e(config('setting.currencyFormat')); ?>

                        <?php echo e(fancyNumberFormat($displayEarnings)); ?></div>
...
</div><?php /**PATH C:\xampp\htdocs\Sommelier\resources\views/admin/partials/dashboardStats.blade.php ENDPATH**/ ?>