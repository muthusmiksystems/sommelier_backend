...
<?php $__env->startSection("title"); ?> Store Owner's Stores - Dashboard
...
<div class="col-md-12">
    <div class="card">
        <div class="card-body">
            ...
            <div class="form-group row form-group-feedback form-group-feedback-right">
                ...
                <div class="col-lg-9">
                    <p class="text-warning"><?php echo e($user->name); ?> is not an owner of any store.</p>
                </div>
                <?php else: ?>
                <br>
                <div class="col-lg-9">
                    <p><strong><?php echo e($user->name); ?></strong> is the owner of <strong><?php echo e($userRestaurants->count()); ?> </strong> stores.</p>
    ...
    <div class="col-md-12 hidden" id="manageRestaurantsBlock">
        ...
        <div class="card">
            <div class="card-body">
                <div class="col-lg-12">
                    <form action="<?php echo e(route('admin.updateManageRestaurantOwnersRestaurants')); ?>" method="POST">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Sommelier\resources\views/admin/manageRestaurantOwnersRestaurants.blade.php ENDPATH**/ ?>