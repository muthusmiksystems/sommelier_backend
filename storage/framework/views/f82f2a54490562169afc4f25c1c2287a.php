...
<div class="content mt-3">
    <div class="d-flex justify-content-between my-2">
        <h3><strong><?php echo e(__('storeDashboard.ordersPageTitle')); ?></strong></h3>
        <div>
            <button type="button" class="btn btn-secondary btn-labeled btn-labeled-left" id="clearFilterAndState"> <b><i
                        class=" icon-reload-alt"></i></b> <?php echo e(__('storeDashboard.resetFilterButton')); ?></button>
        </div>
    </div>
    <div class="card">
        <div class="card-body">
                    ...
                    <table class="table table-striped" id="ordersDataTable" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo e(__('storeDashboard.ovPaymentMode')); ?></th>
                                <th><?php echo e(__('storeDashboard.ovTotal')); ?></th>
                                <th><?php echo e(__('storeDashboard.ovOrderPlaced')); ?></th>
                                <th class="text-center"><?php echo e(__('storeDashboard.liveTimerText')); ?></th>
    ...
    $(function() {
        ...
        $('body').tooltip({selector: '[data-popup="tooltip"]'});
         ...
         var datatable = $('#ordersDataTable').DataTable({
            ...
            order: [[ 0, "desc" ]],
            ajax: '<?php echo e(route('restaurant.ordersDataTable')); ?>',
            columns: [
            ...
            language: {
                search: '_INPUT_',
                searchPlaceholder: '<?php echo e(__('storeDashboard.searchPlaceholder')); ?>',
                lengthMenu: '_MENU_',
                paginate: { 'first': 'First', 'last': 'Last', 'next': '&rarr;', 'previous': '&larr;' },
                processing: '<i class="icon-spinner10 spinner position-left mr-1"></i><?php echo e(__('storeDashboard.waitingForServerResponseText')); ?>'
            },
           buttons: {
                   dom: {
                       button: {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Sommelier\resources\views/restaurantowner/orders.blade.php ENDPATH**/ ?>