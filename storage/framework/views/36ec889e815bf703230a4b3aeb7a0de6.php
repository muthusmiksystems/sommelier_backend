...
<?php $__env->startSection("title"); ?> Edit Addon Category - Dashboard
    ...
    <div class="page-header-content header-elements-md-inline">
        <div class="page-title d-flex">
            <h4><i class="icon-circle-right2 mr-2"></i>
                ...
                <span class="badge badge-primary badge-pill animated flipInX">"<?php echo e($addonCategory->name); ?>"</span>
            </h4>
...
<div class="content">
    <div class="col-md-8">
        <div class="card">
            <div class="card-body">
                <form action="<?php echo e(route('admin.updateAddonCategory')); ?>" method="POST" enctype="multipart/form-data">
...
<script>
    function add(data) {
        ...
        function del(id) {
          ...
          if (r == true) {
            let url = "<?php echo e(url('admin/addon/delete/')); ?>/"+id;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Sommelier\resources\views/admin/editAddonCategory.blade.php ENDPATH**/ ?>