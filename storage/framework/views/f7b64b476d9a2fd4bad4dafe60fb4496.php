...
<?php $__env->startSection("title"); ?> Delivery Guy's Stores - Dashboard
...
<div class="content">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                ...
                <?php if(!$user->delivery_guy_detail): ?>
                    <p>All details for <?php echo e($user->name); ?> are not filled. Please fill all the mandatory details to assign stores to <?php echo e($user->name); ?></p>
                    <strong><a href="<?php echo e(route('admin.get.editUser', $user->id)); ?>#deliveryGuyDetails">Click Here </a></strong> to Edit the Details
                <?php else: ?>
    ...
    <div class="col-md-12 hidden" id="manageRestaurantsBlock">
        ...
        <div class="card">
            <div class="card-body">
                <div class="col-lg-12">
                    <form action="<?php echo e(route('admin.updateDeliveryGuysRestaurants')); ?>" method="POST">
                        ...
                        <div class="assigning-checkboxes mt-3">
                            ...
                            <label>
                            <input type="checkbox" data-name="<?php echo e($ar->name); ?>" name="user_restaurants[]" value="<?php echo e($ar->id); ?>" <?php if(in_array($ar->id, $userRestaurantsIds)): ?> checked="checked" <?php endif; ?>/>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Sommelier\resources\views/admin/manageDeliveryGuysRestaurants.blade.php ENDPATH**/ ?>