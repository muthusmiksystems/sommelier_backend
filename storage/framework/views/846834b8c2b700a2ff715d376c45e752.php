...
<?php $__env->startSection("title"); ?> Edit Coupon - Dashboard
    ...
    <div class="page-header-content header-elements-md-inline">
        <div class="page-title d-flex">
            <h4>
                ...
                <span class="font-weight-bold mr-2"><?php echo e($coupon->name); ?> - <?php echo e($coupon->code); ?></span>
            </h4>
...
<div class="content">
    <div class="col-md-8">
        <div class="card">
            <div class="card-body">
                <form action="<?php echo e(route('admin.updateCoupon')); ?>" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input value="<?php echo e($coupon->name); ?>" type="text" class="form-control form-control-lg"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input value="<?php echo e($coupon->description); ?>" type="text" class="form-control form-control-lg"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input value="<?php echo e($coupon->code); ?>" type="text" class="form-control form-control-lg"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <select class="form-control select-search select" name="discount_type" required>
                                <option value="AMOUNT" class="text-capitalize" <?php if($coupon->discount_type == "AMOUNT"): ?>
                                    selected="selected" <?php endif; ?>>
                                    Fixed Amount Discount
                                </option>
                                <option value="PERCENTAGE" class="text-capitalize" <?php if($coupon->discount_type ==
                                    "PERCENTAGE"): ?> selected="selected" <?php endif; ?>>
                                    Percentage Discount
                                </option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row <?php if($coupon->discount_type ==" AMOUNT"): ?> hidden <?php endif; ?>" id="max_discount">
                        ...
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg max_discount" name="max_discount"
                                placeholder="Max discount applicable in <?php echo e(config('setting.currencyFormat')); ?>"
                                value="<?php echo e($coupon->max_discount); ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label"><span class="text-danger">*</span>Coupon
                            Discount:</label>
                        <div class="col-lg-9">
                            <input value="<?php echo e($coupon->discount); ?>" type="text"
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-9">
                                <input type="text" class="form-control form-control-lg daterange-single"
                                    value="<?php echo $coupon->expiry_date->format('m-d-Y'); ?>" name="expiry_date">
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <select class="form-control select-search couponStoreSelect" name="restaurant_id[]" required
                                ...
                                <option value="<?php echo e($restaurant->id); ?>" class="text-capitalize"
                                    <?php echo e(isset($coupon) && in_array($restaurant->id, $couponAssignedRestaurants) ? 'selected' : ''); ?>>
                    ...
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label"><span class="text-danger">*</span>Max number of
                            use in total:</label>
                        <div class="col-lg-9">
                            <input value="<?php echo e($coupon->max_count); ?>" type="text"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg min_subtotal" name="min_subtotal"
                                placeholder="Min subtotal required for coupon in <?php echo e(config('setting.currencyFormat')); ?>"
                                value="<?php echo e($coupon->min_subtotal); ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg" name="subtotal_message"
                                placeholder="Subtotal not reached message" value="<?php echo e($coupon->subtotal_message); ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <select class="form-control select-search select" name="user_type" required>
                                <option value="ALL" class="text-capitalize" <?php if($coupon->user_type == "ALL"): ?>
                                    selected="selected" <?php endif; ?>>
                                    Unlimited times for all users
                                </option>
                                <option value="ONCENEW" class="text-capitalize" <?php if($coupon->user_type == "ONCENEW"): ?>
                                    selected="selected" <?php endif; ?>>
                                    Once for new user for first order
                                </option>
                                <option value="ONCE" class="text-capitalize" <?php if($coupon->user_type == "ONCE"): ?>
                                    selected="selected" <?php endif; ?>>
                                    Once per user
                                </option>
                                <option value="CUSTOM" class="text-capitalize" <?php if($coupon->user_type == "CUSTOM"): ?>
                                    selected="selected" <?php endif; ?>>
                    ...
                    <div class="form-group row <?php if($coupon->user_type != " CUSTOM"): ?> hidden <?php endif; ?>" id="maxUsePerUser">
                        ...
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg max_count_per_user"
                                ...
                                <?php if($coupon->user_type == "CUSTOM"): ?> required="required" <?php endif; ?>
                            value="<?php echo e($coupon->max_count_per_user); ?>">
                        </div>
                    </div>
                    <script>
                        ...
                        <div class="col-lg-9 d-flex align-items-center">
                            <div class="checkbox checkbox-switchery">
                                <input value="true" type="checkbox" class="switchery-primary isactive"
                                    <?php if($coupon->is_active): ?> checked="checked" <?php endif; ?> name="is_active">
                            </div>
                        </div>
                    </div>
                    <?php echo csrf_field(); ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="mt-4 d-flex justify-content-center align-items-center">
                    <a href="<?php echo e(route('admin.deleteCoupon', $coupon->id)); ?>" class="btn btn-primary mr-2">Yes</a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Sommelier\resources\views/admin/editCoupon.blade.php ENDPATH**/ ?>