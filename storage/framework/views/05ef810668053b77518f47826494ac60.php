...
<script>
    $('body').tooltip({selector: '[data-popup="tooltip"]'});
     var datatable = $('#usersDatatable').DataTable({
        ...
        order: [[ 0, "desc" ]],
        ajax: '<?php echo e(route('storeOwner.deliveryGuyUsersDatatable')); ?>',
        columns: [
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Sommelier\resources\views/admin/restaurantmanageDeliveryGuys.blade.php ENDPATH**/ ?>