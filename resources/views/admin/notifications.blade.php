                    ...
                    <div class="d-lg-flex justify-content-lg-left">
                        ...
                        <div class="tab-content" style="width: 100%; padding: 0 25px;">
                            <div class="tab-pane fade show active" id="toAll">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        ...
                                        <div class="uploader">
                                            <form method="POST" action="{{  Route::currentRouteName() == 'restaurant.notifications' ? route('restaurant.uploadNotificationImage') : route('admin.uploadNotificationImage') }}"
                                ...
                                <form action="{{ Route::currentRouteName() == 'restaurant.notifications' ? route('restaurant.sendNotifiaction') : route('admin.sendNotifiaction') }}" method="POST"
                            ...
                            <div class="tab-pane fade" id="toSelected">
                                ...
                                <form action="{{ Route::currentRouteName() == 'restaurant.notifications' ? route('restaurant.sendNotificationToSelectedUsers') : route('admin.sendNotificationToSelectedUsers') }}" method="POST"
                                    enctype="multipart/form-data">
                                    <div class="form-group row">
                            ...
                            <div class="tab-pane fade" id="toNonRegisteredUsers">
                                ...
                                <form action="{{ Route::currentRouteName() == 'restaurant.notifications' ? route('restaurant.sendNotificationToNonRegisteredAppUsers') : route('admin.sendNotificationToNonRegisteredAppUsers') }}"
...
<script>
    ...
    $(function() {
       ...
       $('.select').select2({
           ...
           ajax: { 
                url: "{{ Route::currentRouteName() == 'restaurant.notifications' ? route('restaurant.getUsersToSendNotification') : route('admin.getUsersToSendNotification')}}",
                type: "get",
                dataType: 'json',
                delay: 250,
