...
<div class="content">
    <div class="col-md-12">
        <div class="card" style="min-height: 100vh;">
            <div class="card-body">
                <form action="{{ route('admin.saveRestaurantSettings') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="d-lg-flex justify-content-lg-left">
                        ...
                        <div class="tab-content" style="width: 100%; padding: 0 25px;">
                            <div class="tab-pane fade show active" id="bepoz_settings">
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-9">
                                        <button type="submit" class="btn btn-primary btn-labeled btn-lg" formaction="{{ route('admin.checkBepozConnection') }}" name="action" value="check_connection">CHECK CONNECTION</button>
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane fade" id="store_features">
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-12" style="display:flex;">
                                        <input type="checkbox" class="" style="width:35px;height:20px;" name="sommelier_online_enb" value="yes" {{ (isset($restaurant->is_active) && $restaurant->is_active == 1) ? 'checked=checked' : '' }}> 
                                        <label class="ml-2"><strong>Sommelier Online</strong></label>
                                    </div> 
                                </div>
                                <div class="form-group row">
                                    <div class="col-lg-12" style="display:flex;">
                                        <input type="checkbox" class="" style="width:35px;height:20px;" name="sommelier_reservations_enb" value="yes" {{ (isset($restaurant_settings->sommelier_reservations) && $restaurant_settings->sommelier_reservations == "yes") ? 'checked=checked' : '' }}>
                                        <label class="ml-2"><strong>Sommelier Reservations</strong></label>
                                    </div> 
                                </div>
                                <div class="form-group row">
                                    <div class="col-lg-12" style="display:flex;">
                                        <input type="checkbox" class="" style="width:35px;height:20px;" name="sommelier_functions_enb" value="yes" {{ (isset($restaurant_settings->sommelier_functions) && $restaurant_settings->sommelier_functions == 'yes') ? 'checked=checked' : '' }}>
                                        <label class="ml-2"><strong>Sommelier Functions</strong></label>
                                    </div> 
                                </div>
                                <div class="form-group row">
                                    <div class="col-lg-12" style="display:flex;">
                                        <input type="checkbox" class="" style="width:35px;height:20px;" name="somemmlier_loyalty_enb" value="yes" {{ (isset($restaurant_settings->somemmlier_loyalty ) && $restaurant_settings->somemmlier_loyalty == 'yes') ? 'checked=checked' : '' }}>
                                        <label class="ml-2"><strong>Somemmlier Loyalty</strong></label>
                                    </div> 
                                </div>
                                <div class="form-group row">
                                    <div class="col-lg-12" style="display:flex;">
                                        <input type="checkbox" class="" style="width:35px;height:20px;" name="sommelier_time_attendance_enb" value="yes" {{ (isset($restaurant_settings->sommelier_time_attendance) && $restaurant_settings->sommelier_time_attendance == 'yes') ? 'checked=checked' : '' }}>
