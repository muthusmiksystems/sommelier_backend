    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse" id="navbar-navigation">
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    <a href="javascript:void(0)"
                        class="navbar-nav-link dropdown-toggle  {{ Request::is('restaurant-owner/users') || Request::is('admin/manage-delivery-guys') || Request::is('admin/staffs') || Request::is('admin/customers') || Request::is('admin/usemanage-store-owners') ? 'active' : '' }}"
                        data-toggle="dropdown">
                        <i class="icon-users2 mr-2"></i>
                        Users
                    </a>
                    ...
                    <div class="dropdown-menu">
                        <a href="{{ route("restaurant.users") }}"
                        class="navbar-nav-link {{ Request::is('restaurant-owner/users') ? 'active' : '' }}">
                        <i class="icon-users4 mr-2"></i>
                        All Users
                    </a>

                        <a href="{{ route("restaurant.customers") }}"
                            class="dropdown-item {{ Request::is('restaurant-owner/customers') ? 'active' : ''}}"> <i
                                class="icon-user mr-2"></i> Customers</a>

                        <a href="{{ route('restaurant.manageRestaurantOwners') }}"
                            class="dropdown-item {{ Request::is('restaurant-owner/manage-store-owners') ? 'active' : ''}}"> <i
                                class="icon-user-tie mr-2"></i> Store Owners</a>
                        <a href="{{ route('restaurant.manageDeliveryGuys') }}"
                            class="dropdown-item {{ Request::is('restaurant-owner/manage-delivery-guys') ? 'active' : ''}}"> <i
                                class="icon-truck mr-2"></i> Delivery Guys</a>

                        <a href="{{ route("restaurant.staffs") }}"
                            class="dropdown-item {{ Request::is('restaurant-owner/staffs') ? 'active' : ''}}"> <i
                                class="icon-collaboration mr-2"></i> Staff</a>
                    </div>
                </li>
                <li class="nav-item dropdown">
                ...
                @if((isset($is_active) && $is_active == 0) && (isset($reservation) && $reservation->sommelier_reservations == 'yes'))
                <li class="nav-item dropdown">
                    <a href="javascript:void(0)"
                        class="navbar-nav-link dropdown-toggle {{ Request::is('restaurant-owner/bookings') ? 'active' : '' }}"
                        data-toggle="dropdown">
                        <i class="icon-book mr-2"></i>
                        {{__('storeDashboard.navBookings')}}
                    </a>
                    <div class="dropdown-menu">
                        <a href="{{ route("restaurant.bookings") }}" class="navbar-nav-link {{ Request::is('restaurant-owner/bookings') ? 'active' : '' }}">
                        <i class="icon-book mr-2"></i>
                        {{__('storeDashboard.navBookingsList')}}
                        </a>
                        <a href="{{ route("restaurant.assignTable") }}" class="navbar-nav-link {{ Request::is('restaurant-owner/assignTable') ? 'active' : '' }}">
                    <i class="icon-book mr-2"></i>
                    {{__('storeDashboard.assignTable')}}
                    </a>
                    </div>
                </li>
                @elseif((isset($is_active) && $is_active == 1) && (isset($reservation) && $reservation->sommelier_reservations == 'no'))
                <li class="nav-item">
                ...
                @elseif((isset($is_active) && $is_active == 1) && (isset($reservation) && $reservation->sommelier_reservations == 'yes'))
                <li class="nav-item dropdown">
                    <a href="javascript:void(0)"
                        class="navbar-nav-link dropdown-toggle {{ Request::is('restaurant-owner/bookings') ? 'active' : '' }}"
                        data-toggle="dropdown">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a href="{{ route('restaurant.sliders') }}"
                            class="dropdown-item {{ Request::is('admin/sliders') ? 'active' : '' }}">
                            <i class="icon-image2 mr-2"></i>
                            Promo Sliders
                        </a>
