            ...
            <div class="card-body">
                <form action="{{ route('admin.updateItem') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg" name="bepoz_pid" placeholder="POS Product ID" value="{{ $item->bepoz_pid }}"
                                >
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg" name="bepoz_psize" placeholder="POS Product Size" value="{{ $item->bepoz_psize }}"
                                >
                        </div>
                    </div>
