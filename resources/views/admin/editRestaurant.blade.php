                        ...
                        <div class="tab-content" style="width: 100%; padding: 0 25px;">
                            ...
                            <div class="tab-pane fade show active" id="generalSettings">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input value="{{ $restaurant->stripe_account_id }}" type="text" class="form-control form-control-lg stripe_account_id" name="stripe_account_id"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <img src="{{ substr(url("/"), 0, strrpos(url("/"), '/')) }}{{ $restaurant->background_image }}"
                                            alt="background_image" width="160" style="border-radius: 0.275rem;">
                                        <img class="slider-preview-image hidden" style="border-radius: 0.275rem;" />
                                        <div class="uploader">
                                            <input type="hidden" name="background_image" value="{{ $restaurant->background_image }}">
