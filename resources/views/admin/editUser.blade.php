            ...
            <div class="card-body" style="min-height: 60vh;">
                <form action="{{ route('admin.updateUser') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="d-lg-flex justify-content-lg-left">
                        ...
                        <div class="tab-content" style="width: 100%; padding: 0 25px;">
                            ...
                            <div class="col-lg-9">
                                <input type="text" class="form-control form-control-lg" name="dob"
                                    value="{{ date('d-m-Y', strtotime($user->dob)) }}" placeholder="DD-MM-YYYY" required
                                    autocomplete="new-name">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input type="text" class="form-control form-control-lg" name="licence_no"
                                    value="{{ $user->licence_no }}" placeholder="Enter Licence No"
                                    autocomplete="new-name">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                                @if(!empty($user->licence_photo))
                                <div class="col-lg-9 offset-lg-3">
                                    <img src="{{ substr(url('/'), 0, strrpos(url('/'), '/')) }}/assets/img/delivery/{{ $user->licence_photo }}" alt="delivery-photo" class="img-fluid mb-2" style="width: 90px; border-radius: 50%">
                                </div>
                                @endif
                            ...
                            <div class="form-group row">
                                    ...
                                    @foreach($userRestaurants as $key => $ar)
    <label>
        <input type="radio" data-slug="{{ $ar->slug }}" name="user_restaurants[]" value="{{ $ar->id }}" onchange="updateSlug()" @if($key === 0 ) checked="checked" @endif/>
        <span>{{ $ar->name }}</span>
    </label>
@endforeach
...
<p id="selectedSlug" onclick="copyURL()">URL:<strong>https://{{ request()->getHttpHost() }}/stores/<span id="storeURL">{{ $userRestaurants[0]->slug ?? '' }}</span></strong>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="stripe_account_id"
                                            value="{{ !empty($user->stripe_account_id) ? $user->stripe_account_id : "" }}" placeholder="Enter Stripe Account Id" autocomplete="new-name">
                                    </div>
                               ...
                               <!-- <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <select class="form-control form-control-lg" name="vehicle_type">
                                        ...
                                        <option value="{{ $vehicle_type->id }}" {{ ($user->delivery_guy_detail->vehicle_type == $vehicle_type->id) ? "selected='selected'" : ""}}>{{ $vehicle_type->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div> 
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" class="form-control form-control-lg" name="registration_no"
                                        value="{{ $user->delivery_guy_detail->registration_no }}" placeholder="Enter Registartion No" required
                                        autocomplete="new-name">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" class="form-control form-control-lg" name="abn_no"
                                        value="{{ $user->delivery_guy_detail->abn_no }}" placeholder="Enter ABN No" required
                                        autocomplete="new-name">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" class="form-control form-control-lg" name="bank_name"
                                        value="{{ $user->delivery_guy_detail->bank_name }}" placeholder="Enter Bank Name" required
                                        autocomplete="new-name">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" class="form-control form-control-lg" name="bsb"
                                        value="{{ $user->delivery_guy_detail->bsb }}" placeholder="Enter BSB" required
                                        autocomplete="new-name">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input type="number" class="form-control form-control-lg" name="account_number"
                                        value="{{ $user->delivery_guy_detail->account_number }}" placeholder="Enter Account Number" required
                                        autocomplete="new-name">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" class="form-control form-control-lg" name="account_name"
                                        value="{{ $user->delivery_guy_detail->account_name }}" placeholder="Enter Account Name" required
                                        autocomplete="new-name">
                                </div>
                            </div>
                            <div class="form-group row">
                                @if(!empty($user->delivery_guy_detail->vehicle_registration))
                                <div class="col-lg-9 offset-lg-3">
                                    <a href="{{ substr(url('/'), 0, strrpos(url('/'), '/')) }}/assets/img/delivery/{{ $user->delivery_guy_detail->vehicle_registration }}" target="_blank"><img src="{{ substr(url('/'), 0, strrpos(url('/'), '/')) }}/assets/img/delivery/{{ $user->delivery_guy_detail->vehicle_registration }}" alt="delivery-photo" class="img-fluid mb-2" style="width: 90px; border-radius: 50%"></a>
                                </div>
                                @endif
                            ...
                            <div class="form-group row">
                                @if(!empty($user->delivery_guy_detail->vehicle_insurance_policy))
                                <div class="col-lg-9 offset-lg-3">
                                <a href="{{ substr(url('/'), 0, strrpos(url('/'), '/')) }}/assets/img/delivery/{{ $user->delivery_guy_detail->vehicle_insurance_policy }}" target="_blank"><img src="{{ substr(url('/'), 0, strrpos(url('/'), '/')) }}/assets/img/delivery/{{ $user->delivery_guy_detail->vehicle_insurance_policy }}" alt="delivery-photo" class="img-fluid mb-2" style="width: 90px; border-radius: 50%"></a>
                                </div>
                                @endif
                            ...
                            <div class="form-group row">
                                @if(!empty($user->delivery_guy_detail->certificate))
                                <div class="col-lg-9 offset-lg-3">
                                <a href="{{ substr(url('/'), 0, strrpos(url('/'), '/')) }}/assets/img/delivery/{{ $user->delivery_guy_detail->certificate }}" target="_blank"><img src="{{ substr(url('/'), 0, strrpos(url('/'), '/')) }}/assets/img/delivery/{{ $user->delivery_guy_detail->certificate }}" alt="delivery-photo" class="img-fluid mb-2" style="width: 90px; border-radius: 50%"></a>
                                </div>
                                @endif
                            ...
                            <div class="form-group row">
                                @if(!empty($user->delivery_guy_detail->police_clearence_certificate))
                                <div class="col-lg-9 offset-lg-3">
                                <a href="{{ substr(url('/'), 0, strrpos(url('/'), '/')) }}/assets/img/delivery/{{ $user->delivery_guy_detail->police_clearence_certificate }}" target="_blank"><img src="{{ substr(url('/'), 0, strrpos(url('/'), '/')) }}/assets/img/delivery/{{ $user->delivery_guy_detail->police_clearence_certificate }}" alt="delivery-photo" class="img-fluid mb-2" style="width: 90px; border-radius: 50%"></a>
                                </div>
                                @endif
