    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route("storeOwner.saveNewUser") }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row hidden">
                        ...
                        <div class="col-lg-9">
                            <input class="form-control form-control-lg" type="text" name="restaurantIds[]" value="{{ $restaurantIds[0] ?? '' }}">
                        </div>
                    </div>
...
<script>
    $(function () {
        ...
        var datatable = $('#usersDatatable').DataTable({
            ...
            order: [[0, "desc"]],
            ajax: '{{ route('storeOwner.usersDatatable') }}',
            columns: [
