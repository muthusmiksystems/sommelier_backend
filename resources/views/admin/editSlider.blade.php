                        ...
                        <div class="form-group row"  id="positionSelectRow">
                            ...
                            <div class="col-lg-8">
                                <select name="position_id" class="form-control form-control-lg select">
                                    <option value="0" @if($slider->position_id == 0) selected="selected" @endif>Main
                                        Position</option>
                                    <option value="1" @if($slider->position_id == 1) selected="selected" @endif>After 1st
                                        Store</option>
                                    <option value="2" @if($slider->position_id == 2) selected="selected" @endif>After 2nd
                                        Store</option>
                                    <option value="3" @if($slider->position_id == 3) selected="selected" @endif>After 3rd
                                        Store</option>
                                    <option value="4" @if($slider->position_id == 4) selected="selected" @endif>After 4th
                                        Store</option>
                                    <option value="5" @if($slider->position_id == 5) selected="selected" @endif>After 5th
                                        Store</option>
                                    <option value="6" @if($slider->position_id == 6) selected="selected" @endif>After 6th
                                        Store</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <select id="viewSelect" name="view" class="form-control form-control-lg" required>
                                    <option value="mobile" @if($slider->view == 'mobile') selected="selected" @endif>
                                        Mobile</option>
                                    <option value="web" @if($slider->view == 'web') selected="selected" @endif>Web
                                    </option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group row" id="sizeSelectRow">
                            ...
                            <div class="col-lg-8">
                                <select name="size" class="form-control form-control-lg select" required="required">
                                    <option value="1" @if($slider->size == 1) selected="selected" @endif>Extra Small
                                    </option>
                                    ...
                                    <option value="5" @if($slider->size == 5) selected="selected" @endif>Extra Large
                                    </option>
                                </select>
                            </div>
                        </div>
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-body">
                            ...
                            @foreach($slides as $slide)
                                <div class="col-md-3 mb-2 each-slide" data-id="{{ $slide->id }}">
                                    ...
                                    <img src="{{ substr(url("/"), 0, strrpos(url("/"), '/')) }}{{ $slide->image }}"
                                        alt="{{ $slide->name }}" width="150" height="150" data-popup="tooltip"
                                        title="{{ $slide->link }}" data-placement="right">
                                    <div class="btn-group btn-group-justified" style="width: 150px">
                                        <a href="{{ route('admin.editSlide', $slide->id) }}" class="btn btn-dark rounded-0"
                                            data-popup="tooltip" title="Edit Slide" data-placement="bottom"> <i
                                                class="icon-pencil3"></i> </a>
                                        <a href="{{ route('admin.deleteSlide', $slide->id) }}" class="btn btn-danger"
                                            data-popup="tooltip" title="Delete Slide" data-placement="bottom"> <i
                                                class="icon-trash"></i> </a>
                                        @if($slide->is_active)
                                            <a href="{{ route('admin.disableSlide', $slide->id) }}"
                    ...
                    @endif
                    <form action="{{ route('admin.saveSlide') }}" method="POST" id="slideForm" class="mt-3 hidden"
                        enctype="multipart/form-data">
                        <legend class="font-weight-semibold text-uppercase font-size-sm">
                            Add New Slide
                        </legend>
                        <input type="hidden" class="form-control form-control-lg" name="promo_slider_id"
                            value="{{ $slider->id }}" required>
                        <div class="form-group row">
