...
@section("title") Promo Slider's Stores - Dashboard
@endsection
@section('content')
<style>
...
<div class="content">
        ...
        <div class="card">
            <div class="card-body">
                <legend class="font-weight-semibold text-uppercase font-size-sm">
                    <i class="icon-address-book mr-2"></i> {{ $user->name }}'s Stores
                </legend>
    ...
    <div class="col-md-12 hidden" id="manageRestaurantsBlock">
        ...
        <div class="card">
            <div class="card-body">
                <div class="col-lg-12">
                    <form action="{{ route('restaurant.updateStoreOwnerSlider') }}" method="POST">
    ...
    <input type="hidden" name="sliderid[]" value="{{ $ar->id }}">
    <label>
        <input type="checkbox" 
               data-name="{{ $ar->name }}" 
               name="user_restaurants[]" 
               value="{{ $ar->id }}" 
               @if($ar->slides->contains('is_active', 1)) checked="checked" @endif />
        <span>{{ $ar->name }}</span>
    </label>
@endforeach
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('restaurant.createSlider') }}" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="userRestaurantsIds" value="{{ implode(',', $userRestaurantsIds) }}">
