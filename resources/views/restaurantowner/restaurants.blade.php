                            ...
                            <td class="text-center">
                                <div class="btn-group btn-group-justified">
                                    <a href="{{ route('restaurant.get.editRestaurant', $restaurant->id) }}"
                                        ...
                                        <a href="{{ route('restaurant.get.tableShiftRestaurant', $restaurant->id) }}"
                                        class="badge badge-primary badge-icon ml-1"> {{__('storeDashboard.resTableShift')}} <i
                                        class="icon-cog3 ml-1"></i></a>
                                    <a href="{{ route('restaurant.get.settingsRestaurant', $restaurant->id) }}"
                                        class="badge badge-primary badge-icon ml-1"> {{__('storeDashboard.resSetting')}} <i
                                        class="icon-cog3 ml-1"></i></a>
                                </div>
                            </td>
                        </tr>
