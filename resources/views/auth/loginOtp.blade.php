...
<form class="registration-form py-5" action="{{ route('post.loginotp') }}" method="POST" id="loginForm"
    ...
    <div class="card mb-0">
        <div class="card-body" style="width:372px;">
            ...
            @if(config('setting.enPassResetEmail') == 'true')
            <div class="mb-2">
            ...
            <div class="content d-flex justify-content-center align-items-center mt-3">
                <!--<a class="btn btn-lg btn-registerBtn mr-2" href="{{ route('storeRegistration') }}">Register for
                    Store</a>
                <a class="btn btn-lg btn-registerBtn" href="{{ route('deliveryRegistration') }}">Register for
                    Delivery</a> -->
                    <a href="{{ route('registerDelivery') }}" class="btn btn-lg btn-registerBtn mr-2">Register for Delivery</a>
            </div>
        </div>
    </div>
</form>
