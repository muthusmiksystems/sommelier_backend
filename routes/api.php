...
Route::post('/register-otp', [UserController::class, 'registerotp']);
...
Route::get('/restaurant-venue/{id}', [RestaurantOwnerController::class, 'getRestaurantVenue'])->name('restaurant.get.getRestaurantVenue');
Route::get('/restaurant-table-areas-ext/{id}', [RestaurantOwnerController::class, 'getTableAreas'])->name('restaurant.get.getTableAreasExt');
