...
{
    public function deliveryCollections(): View
    {
        return view('admin.deliveryCollections');
    }

    public function collectDeliveryCollection(Request $request): RedirectResponse
    {
    ...
    public function deliveryCollectionLogs(Request $request): View
    {
        ...
        return view('admin.deliveryCollectionLogs', [
            'user' => $user,
