...
class StoreOwnerAppController extends Controller
{
    ...
    public function getSingleLanguage($language_code): JsonResponse
    {
    ...
    public function getSingleOrder(Request $request): JsonResponse
    {
        $user = Auth::user();
        ...
        $order = Order::where('id', $request->order_id)
            ...
            ->with(['accept_delivery.user' => function ($query) {
    ...
    public function markSelfpickupOrderReady(Request $request): JsonResponse
    {
        $user = Auth::user();
        $restaurantIds = $user->restaurants->pluck('id')->toArray();
    ...
    public function markSelfpickupOrderCompleted(Request $request): JsonResponse
    {
        $user = Auth::user();
        $restaurantIds = $user->restaurants->pluck('id')->toArray();
    ...
    public function confirmScheduledOrder(Request $request): JsonResponse
    {
        $user = Auth::user();
        $restaurantIds = $user->restaurants->pluck('id')->toArray();
    ...
    public function sendPayoutRequest(Request $request): JsonResponse
    {
        $user = Auth::user();
    ...
    public function getInactiveItems(Request $request): JsonResponse
    {
        $user = Auth::user();
        $restaurantIds = $user->restaurants->pluck('id')->toArray();
    ...
    public function getStorePage(Request $request): JsonResponse
    {
        $user = Auth::user();
        if ($user) {
    ...
    public function toggleCategoryStatus(Request $request): JsonResponse
    {
        $user = Auth::user();
