...
class Order extends Model
{
    ...
    {
        return $this->hasOne(\App\GpsTable::class);
    }
    ...
    {
        return $this->hasOne(\App\AcceptDelivery::class);
    }
    ...
    {
        return $this->hasOne(\App\Rating::class);
    }
    ...
    {
        return $this->hasOne(\App\RazorpayData::class);
    }
}
