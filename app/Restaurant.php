...
class Restaurant extends Model implements Sortable
{
    ...
    {
        return $this->belongsToMany(\App\RestaurantCategory::class, 'restaurant_category_restaurant');
    }
    ...
    {
        return $this->hadMany(\App\StorePayoutDetail::class);
    }
    ...
    {
        return $this->hasMany(\App\RestaurantEarning::class);
    }

    public function restaurant_payouts()
    {
        return $this->hasMany(\App\RestaurantPayout::class);
    }

    /* Custom Function */
    public function restaurantSettings()
    {
        return $this->hasOne(\App\RestaurantSettings::class);
    }
}
